...
// Control relay2 for lamp based on time
  ...
  delay(895650); // Delay for 15 minutes -4 second if pumpstate is "triggered"
} else {
  delay(899650); // Delay for 15 minutes if pumpstate is not "triggered"
}

  //if (pumpstate == "triggered") {
  //delay(1650); // Delay for 1.65 seconds if pumpstate is "triggered"
//} else {
//  delay(6650); // Delay for 6.65 seconds if pumpstate is not "triggered"
//}
